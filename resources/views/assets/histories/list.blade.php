<div class='panel form row panel-assets-table-history'>

<div class='panel-header'>
    <h2>{!!__("menu.history")!!}</h2>
    ...
    <script>
        window.addEventListener('load', () => {
            new PanelAssetsTableHistory( document.querySelector('.panel-assets-table-history'), {
                data: {!! json_encode($histories) !!}
            });
        })
    </script>
</div>