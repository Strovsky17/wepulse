<div class='panel-side panel-assets-category'>

    <div class='panel-header'>
        <h4>{!!__("menu.category")!!}</h4>
    </div>
    ...
    <script>
        window.addEventListener('load', () => {
            window.pAssetsCategory = new PanelAssetsCategory( document.querySelector('.panel-assets-category') );
        })
    </script>
</div>